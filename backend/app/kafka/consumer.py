...
class KafkaConsumerService:
    ...
    async def start(self, message_handler: Optional[Callable] = None):
        if self.running:
        ...
        def thread_target():
            ...
            loop.run_until_complete(self._consume_loop())  # Run the async consume loop in this thread
            ...
            while self.running:
                ...
                if msg.error():
                    ...
                    try:
                        ...
                        await self.handler(message_value)  # Corrected from `asyncio.run`
    ...
    async def _default_message_handler(self, message_value: str):
        """
