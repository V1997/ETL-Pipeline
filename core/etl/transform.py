...
class DataTransformer:
    ...
    def transform_batch(self, job_id: str, file_path: str) -> str:
        """
        ...
        try:
            ...
            output_path = os.path.join(settings.DATA_UPLOAD_FOLDER, f"{job_id}_transformed.csv")
            ...
            loader = DataLoader()
            loader.load_batch(job_id, output_path)
